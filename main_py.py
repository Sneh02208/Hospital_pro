...
from main_ui import app, window, create_button, Patient_Fname_input, Patient_lname_input, Phone_number_input, Blood_group_input, email_input, Gender_input, create_password_input
